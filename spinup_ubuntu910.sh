...
# This script is meant to configure a stack on Ubuntu 9.10
...
#
# Grab it from the server using something like this command:
# wget --no-check-certificate $HeadURL: https://sol.rockriverstar.com/svn/server_scripts/trunk/spinup_ubuntu910.sh $

INSTALL_LOG=/var/log/spinup_ubuntu910.log
